...
function About(){
    ...
    <div className="about-page">
        <div className="about-box">
            <div onClick={() => window.open("https://github.com/Dev-Emanuele/portfolio")}>
